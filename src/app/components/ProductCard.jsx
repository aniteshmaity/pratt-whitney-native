...
function ProductCard({ handleExploreClick, engines = [] }) {
          ...
          <View key={engine?.id || index} className="flex flex-row items-center gap-[50px] relative">
            <View className="flex items-center">
              <Animated.View
                ...
                className={`rounded-full scale-[0.9] w-[82px] h-[82px] z-40 relative flex flex-row justify-center items-center bg-white ${index === activeEngineIndex ? 'scale-125' : ''
                  }`}
              >
