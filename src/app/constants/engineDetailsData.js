...
const engineDetails = {
  regional: {
    PW127XT: {
      ...
      defaultTabsData: [
        ...
        },
        {
          title: "Specifications", content: [
            { image: productImages.flyingHours, description: "40% extended time on wing." },
      ...
      gallery: [
        ...
        { video: productImages.PW127XTV_3d },
    ...
    "PW100/150": {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.PW210_S_1, description: "3,300+ aircraft powered. " },
  ...
  military: {
    TF33: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.Thrust, description: "72M+ flight hours on B-52 bombers." },
        ...
        {
          title: "Highlights", content: [
            { image: productImages.TF33_H_1, enginetext: "Proven & Dependable", description: "First flown 60 years ago, over 1,000 TF33 engines remain in service today, including with the U.S. Air Force and various global customers. Since its initial flight, the TF33 has amassed more than 72 million flight hours, primarily powering the B-52 bomber." },
    ...
    "PW4062/F139": {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.F139_S_1, description: "60 operators worldwide depend on the same family of engines. " },
        ...
        {
          title: "Highlights", content: [
            { image: productImages.F139_H_1, enginetext: "Proven Performance", description: "The 94-inch fan versions of the PW4000 engine family have logged over 152 million hours in commercial service, demonstrating exceptional safety, reliability, and durability." },
      ...
      gallery: [
        ...
        { img: productImages.F139_8 },
        { img: productImages.F139_9 },
        { img: productImages.F139_10 },
    ...
    F135: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.F135_S_1, description: "40K+ pounds of thrust. " },
    ...
    F119: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.F135_S_1, description: "35K pounds of thrust. " },
        ...
        {
          title: "Customers", content: [
            { name: "United States Air Force (USAF)", image: productImages.USAairforce },
      ...
      gallery: [
        ...
        { img: productImages.F119_6 },
        { pdf: productImages.Mil_pdf_5 },
        { video: productImages.F119_v_1 },
        { video: productImages.F119_v_2 },
      ]
    },
    F100: {
      title: "F100",
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.F139_S_1, description: "23 Air Forces powered." },
    ...
    F117: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.worldRecord, description: "22 world records set during C-17 qualification testing. " },
            { image: productImages.thrust_new, description: "40.4K pounds of thrust. " },
        ...
        },
        {
          title: "Customers", content: [
            ...
            { name: "United States Air Force", image: productImages.USAairforce },
            { name: "Royal Australian Air Force", image: productImages.royalAusAir },
            { name: "Royal Canadian Air Force", image: productImages.royalCanadaAir },
  ...
  helicopter: {
    PW210: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.PW210_S_2, description: "1,100 shaft horsepower class." },
        ...
        {
          title: "Highlights", content: [
            { image: productImages.Hel_PW210_H_1, enginetext: "Engineered Efficiency", description: "The PW210 combines low fuel consumption, lightweight design, compact architecture, reduced emissions, and minimal maintenance. Built to handle any challenge, it leads its class in power-to-weight ratio and fuel efficiency, delivering exceptional payload, range, and overall customer value." },
      ...
      gallery: [
        ...
        { img: productImages.PW210_5 },
        { video: productImages.PW210_V_1 },
    ...
    PW200: {
      ...
      defaultTabsData: [
        {
          title: "Platforms", content: [{
            image: productImages.Hel_PW200_P_1_new,
          ...
          {
            image: productImages.Hel_PW200_P_2_new,
            enginetext: "Bell 429",
          ...
          {
            image: productImages.Hel_PW200_P_3_new,
          ...
          {
            image: productImages.Hel_PW200_P_4_new,
        ...
        {
          title: "Highlights", content: [
            { image: productImages.Hel_PW200_H_1, enginetext: "Design Simplicity and Efficiency", description: "The PW200 features a straightforward design with only three major rotating components and a modular structure for easy maintenance. Its single-stage centrifugal compressor, driven by a single-stage turbine, powers a free single-stage power turbine through a PT6-style reverse flow combustor." },
    ...
    PT6T: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.PW210_S_2, description: "1,800 to 2,000 shaft-horsepower " },
            { image: productImages.Hel_PW210_S_1, description: "11 models for various requirements. " },
            { image: productImages.thrust_new, description: "Twin power section with a combining gearbox. " },
    ...
    PT6C: {
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.PW210_S_2, description: "1,600 to 2,000 shaft-horsepower class" },
  ...
  general: {
    "PT6 E-Series": {
      ...
      logo: productImages.PT6E_2,
      // video3d: [{ video: productImages.PT6E_3d }],
      defaultTabsData: [
        {
          title: "Platforms", content: [{
            image: productImages.PW210_P_1,
        ...
        {
          title: "Specifications", content: [
            { image: productImages.PW210_S_1, description: "1825 - 1844 Thermodynamic ESHP" },
            { image: productImages.PW210_S_2, description: "40% reduction in scheduled maintenance." },
            { image: productImages.PW210_S_3, description: "100+ parameters monitored for optimum performance.  " },
            { image: productImages.thrust_new, description: "Longer maintenance intervals. " },
      ...
      gallery: [
        ...
        { img: productImages.PT6E_1 },
        { img: productImages.PT6E_2 },
        { img: productImages.PT6E_3 },
        { img: productImages.PT6E_4 },
        { img: productImages.PT6E_5 },
        { img: productImages.PT6E_6 },
        { img: productImages.PT6E_7 },
  ...
  commercial: {
    GTF_Family: {
      ...
      variants: [
        {
          ...
          tabsData: [
            ...
            {
              title: "Specifications", content: [
                { image: productImages.fanDiameter, description: "81” fan diameter. " },
            ...
            {
              title: "Highlights", content: [
                { image: productImages.GTF_V1_H_1, enginetext: "Industry-Leading Efficiency and Sustainability", description: "The GTF engine family offers unmatched fuel efficiency for single-aisle aircraft, cutting fuel consumption and CO2 emissions by up to 20%, NOx emissions by 50%, and reducing noise by 75%." },
                ...
                { image: productImages.GTF_future_propulsion, enginetext: "Future-Ready Propulsion", description: "The GTF engine's geared fan architecture paves the way for even greater efficiency with advancements like the Pratt & Whitney GTF Advantage engine." },
              ]
            },
            {
              title: "Customers", content: [
        ...
        },
        {
          ...
          tabsData: [
            ...
            {
              title: "Specifications", content: [
                { image: productImages.fanDiameter, description: "73” fan diameter." },
                { image: productImages.thrust_new, description: "19K-25K pounds of thrust. " },
            ...
            {
              title: "Highlights", content: [
                { image: productImages.GTF_V2_H_1, enginetext: "Unmatched Efficiency and Sustainability", description: "The Pratt & Whitney GTF engine leads in fuel efficiency and sustainability for single-aisle aircraft. As the exclusive powerplant for the Airbus A220 family, it cuts fuel consumption and CO₂ emissions per seat by up to 25%, reduces NOx emissions by 50%, and lowers noise by 75%." },
      ...
      defaultTabsData: [
        ...
        {
          title: "Specifications", content: [
            { image: productImages.GTF_S_1, description: "20% Fuel and CO2 savings possible per trip with GTF-powered aircraft." },
            ...
            { image: productImages.GTF_S_7, description: "2,000+ Aircraft with 80+ operators." },
            {
              image: productImages.GTF_S_8,
              description:
        ...
        },
        {
          ...
          { image: productImages.GTF_H_new, enginetext: "Geared for the Future", description: "The geared fan is the foundation for future sustainable propulsion. GTF engines, with GTF Advantage for the A320neo family, are already delivering next-generation benefits." },
      ...
      gallery: [
        ...
        { img: productImages.GTF_18 },
        { img: productImages.GTF_19 },
        { img: productImages.GTF_20 },
        { img: productImages.GTF_21 },
        { img: productImages.GTF_22 },
        { video: productImages.GTF_V1 },
        { video: productImages.GTF_V2 },
        { pdf: productImages.GTF_Pdf_1 },
        { pdf: productImages.GTF_Pdf_2 },
        { pdf: productImages.GTF_Pdf_3 },
    ...
    v2500: {
      ...
      variants: [
        {
          ...
          tabsData: [
            ...
            {
              title: "Specifications", content: [
                { image: productImages.V25_S_1, description: "31,300 pounds of thrust" },
      ...
      defaultTabsData: [
        ...
        {
          title: "Highlights", content: [
            { image: productImages.V25_H_1, enginetext: "Industry-Leading Efficiency and Performance", description: "The V2500 engine remains the quietest and most fuel-efficient option for the Airbus A320ceo family, delivering over 3% better fuel burn, lower emissions, and a significant payload-range advantage. Its proven reliability makes it a top choice for commercial, cargo, and military applications." },
    ...
    PW4000: {
      ...
      variants: [
        {
          ...
          tabsData: [
            ...
            {
              title: "Specifications", content: [
                { image: productImages.thrust_new, description: "64.5K – 70K pounds of takeoff thrust." },
                { image: productImages.redCraft, description: "10M+ hours of revenue service. " },
                { image: productImages.V25_S_3, description: "180-minute ETOPS approval." },
                { image: productImages.Talon, description: "TALON II low emissions combustor." },

              ]
            },
            {
              title: "Highlights", content: [
                { image: productImages.PW4_H_1_new, enginetext: "PW4000 100-inch-fan", description: "The PW4000 100-inch fan engine is offered as a complete propulsion system, featuring an advanced, lightweight nacelle and incorporating proven technologies in materials, aerodynamics, and controls to enhance performance, reliability, and durability." },
                { image: productImages.PW4_H_2, enginetext: "ETOPS Certification and Compliance", description: "This engine was the first in aviation history to qualify for Extended-range Twin-engine Operations (ETOPS) before entering service, complying with all current and anticipated noise and exhaust emissions regulations." },
                { image: productImages.PW4_100, enginetext: "Performance and Value", description: "As of May 2010, the PW4000 100-inch fan engines have accumulated over 10 million hours of revenue service on the A330. Its design is built for maximum value, evidenced by its strong service record in the A330 market." },
        ...
        },
        {
          ...
          tabsData: [
            {
              title: "Platforms", content: [{
                image: productImages.PW4_P_2_new,
            ...
            {
              title: "Specifications", content: [
                { image: productImages.thrust_new, description: "74K - 98K pounds of thrust. " },
                { image: productImages.V25_S_5, description: "207-minute ETOPS approval" },
                { image: productImages.roter, description: "Diameter as wide as the fuselage of a Boeing 737 " },
            ...
            {
              title: "Highlights", content: [
                { image: productImages.PW4_H_1_new, enginetext: "PW4000 112-inch-fan", description: "The PW4000 112-inch fan engine, designed for the Boeing 777-200/-200ER/-300, delivers 74,000 to 98,000 pounds of thrust. It was the launch engine for the 777, entering service in 1995" },
                { image: productImages.PW4_H_2, enginetext: "ETOPS Certification", description: "The PW4084 variant provides 84,000 pounds of thrust and was the first engine approved for 180-minute ETOPS, later upgraded to 207 minutes. The PW4090 offers 90,000 pounds for increased-gross-weight models, while the PW4098 supports takeoff weights up to 660,000 pounds" },
                { image: productImages.PW4_112, enginetext: "Design and Efficiency", description: "As Pratt & Whitney's largest commercial engine, the PW4000 features hollow titanium, shroudless fan blades for high efficiency, low noise, and enhanced resistance to foreign object damage." },
            ...
            },
            {
              title: "Customers", content: [
                ...
                { name: "Ethiopian Airlines", image: productImages.Ethiopian },
      ...
      defaultTabsData: [
        {
          title: "Platforms", content: [{
            image: productImages.PW4_P_1_new,
          ...
          {
            image: productImages.PW4_P_3_new,
          ...
          {
            image: productImages.PW4_P_4_new,
          ...
          {
            image: productImages.PW4_P_5_new,
        ...
        {
          title: "Highlights", content: [{ image: productImages.PW4_H_1_new, enginetext: "PW4000 94-inch-fan", description: "The PW4000 100-inch fan engine is offered as a complete propulsion system, featuring an advanced, lightweight nacelle and incorporating proven technologies in materials, aerodynamics, and controls to enhance performance, reliability, and durability." },
      ...
      gallery: [
        ...
        { video: productImages.PW4000_V1 },
        { video: productImages.PW4000_V2 }
    ...
    PW2000: {
      ...
      gallery: [
        ...
        { img: productImages.PW2_4 },
        { pdf: productImages.PW2_pdf_1 },
    ...
    GP7200: {
      ...
      gallery: [
        ...
        { pdf: productImages.P7200_pdf_1 },
        { video: productImages.P7200_V1 },
  ...
  business_aviation: {
    PW800: {
      ...
      gallery: [
        ...
        { pdf: productImages.PW800_pdf_1 },
        { pdf: productImages.PW800_pdf_2 },
        { pdf: productImages.PW800_pdf_3 },
    ...
    PW500: {
      ...
      gallery: [
        ...
        { img: productImages.PW500_4 },
        { pdf: productImages.PW500_pdf_1 },
      ...
      defaultTabsData: [
        {
          title: "Platforms", content: [{
            ...
            image: productImages.PW300_P_1_new,
          ...
          {
            image: productImages.PW300_P_2_new,
          ...
          {
            image: productImages.PW300_P_3_new,
  ...
  APUs: {
      ...
      defaultTabsData: [
        {
          title: "Platforms", content: [{
            ...
            enginetext: "Boeing 787 Dreamliner",
    ...
    APS3200: {
      ...
      gallery: [
        ...
        { img: productImages.APS3200_4 },
        { img: productImages.APS3200_5 },
        { pdf: productImages.APS3200_pdf_1 },
    ...
    APS500: {
      ...
      logo: productImages.APS5000_logo,
      defaultTabsData: [
        {
          title: "Platforms", content: [{
  ...
  legacy_engines: {
      ...
      defaultTabsData: [
        ...
        },
        {
          ...
          content: [
            {
              image: productImages.PW300_H_2,
              description: "~525 to 750 hp (varied by variant)",
            },
            { image: productImages.PW210_S_2, description: "9-cylinder air-cooled radial " },
            { image: productImages.PW2_fadec, description: "Compression ratio: Around 6:1" },
          ],
        },
        {
          title: "Highlights",
          content: [
            {
              ...
              description:
                "The R-1690 Hornet was widely regarded for its durability and consistent operation, especially in long-range and high-duty cycle missions. Its air-cooled design reduced the risk of cooling system failure, a common issue in early liquid-cooled engines.",
            },
            {
              image: productImages.Hernet_H_2,
              enginetext: "Performance and Capability",
              description:
                "Though not the most powerful radial engine of its time, the Hornet was efficient, reliable, and adaptable to a wide variety of aircraft. Its performance contributed significantly to early advancements in passenger and military aviation.",
            },
            {
        ...
        },
        {
          title: "Customers",
          content: [
            { name: "United States Army Air Corps	", image: productImages.USN },
            { name: "United States Navy", image: productImages.USArmy },
            { name: "Pan American Airways", image: productImages.PanAm },
          ],
        },
      ],
      gallery: [{ img: productImages.hornet_1 }, { img: productImages.hornet_2 }, { img: productImages.hornet_3 }, { img: productImages.hornet_4 }],
    },
    JT3D: {
      title: "JT3D",
      subTitle: "For PW India Experience Center",
      ...
      defaultTabsData: [
        ...
        },
        {
          title: "Specifications",
          content: [
            { image: productImages.thrust_new, description: "17,000 to 21,000 lbf thrust" },
            { image: productImages.roter, description: "1.5:1 Bypass ratio" },
          ],
        },
        {
          title: "Highlights",
          content: [
            {
              ...
              enginetext: "Reliability and Safety",
              description:
                "A robust design based on the proven JT3C core, it offered improved reliability and range over its turbojet predecessor.",
            },
            {
              image: productImages.Jt3d_H_2,
              enginetext: "Performance and Capability",
              description:
                "The JT3D allowed airlines to improve operating economics with greater fuel efficiency and lower maintenance demands compared to turbojets.",
            },
            {
              image: productImages.Jt3d_H_3,
              enginetext: "Legacy and Impact",
              description:
                "It helped transition commercial aviation from the turbojet to the turbofan era and enabled intercontinental flight capabilities for early jetliners.",
            },
          ],
        },
        {
          title: "Customers",
          content: [
            { name: "Pan American World Airways	", image: productImages.PanAm },
            { name: "American Airlines", image: productImages.AmericanAir },
            { name: "U.S. Air Force", image: productImages.USAairforce },
            { name: "Lufthansa", image: productImages.lufthansa },
            { name: "Qantas", image: productImages.Qantas },
          ],
        },
      ],
    ...
    JT8D: {
      ...
      subTitle: "For PW India Experience Center",
      description:
        "The JT8D is a low-bypass turbofan engine introduced in the early 1960s. Known for its ruggedness and long service life, the JT8D powered some of the most successful commercial jets in history, including the Boeing 727 and 737-100/200 series. It also saw wide use in military and cargo aircraft.",
      variants: [],
      logo: productImages.Jt8d_2,
      defaultTabsData: [
        {
          title: "Platforms",
          content: [
        ...
        },
        {
          title: "Specifications",
          content: [
            { image: productImages.thrust_new, description: "14,000 to 21,000 lbf thrust " },
            { image: productImages.roter, description: "1.0:1 Bypass ratio   " },
            { image: productImages.settingAero, description: "14,000 units produced" },
          ],
        },
        {
          title: "Highlights",
          content: [
            {
              ...
              enginetext: "Reliability and Safety",
              description:
                "Famous for its longevity, many JT8D engines have operated for decades with high dispatch reliability.",
            },
            {
              image: productImages.Jt8d_H_2,
              enginetext: "Performance and Capability",
              description:
                "The JT8D’s compact and robust design made it ideal for short- to medium-haul airliners and even operation from smaller airports.",
            },
            {
              image: productImages.Jt8d_H_3,
              enginetext: "Legacy and Impact",
              description:
                "With over 14,000 units produced, the JT8D remains one of the most successful commercial jet engines in aviation history.",
            },
          ],
        },
        {
          title: "Customers",
          content: [
            { name: "Delta Air Lines	", image: productImages.Delta },
            { name: "American Airlines", image: productImages.AmericanAir },
            { name: "U.S. Navy", image: productImages.USN },
          ],
        },
      ],
      gallery: [
        { img: productImages.Jt8d_1 },
        { img: productImages.Jt8d_2 },
        { img: productImages.Jt8d_3 },
        { img: productImages.Jt8d_4 },
        { video: productImages.Jt8d_V },
      ],
    },
    JT9D: {
      title: "JT9D",
      subTitle: "For PW India Experience Center",
      description:
        "The JT9D is Pratt & Whitney’s first high-bypass turbofan engine and a pioneering engine for widebody aircraft. It debuted on the Boeing 747, enabling true long-range, high-capacity air travel. Its introduction marked a shift in commercial aviation, supporting larger, quieter, and more efficient airliners.",
      variants: [],
      logo: productImages.Jt9d_1,
      defaultTabsData: [
        {
          title: "Platforms",
          content: [
            {
              image: productImages.Jt9d_P_1,
              enginetext: "Boeing 747",
              description: "",
            },
            {
              image: productImages.Jt9d_P_2,
              enginetext: "McDonnell Douglas DC-10",
              description: "",
            },

            {
              image: productImages.Jt9d_P_3,
              enginetext: "Airbus A300",
              description: "",
            },
          ],
        },
        {
          ...
          content: [
            ...
            { image: productImages.roter, description: "5:1 Bypass ratio" },
          ],
        },
        {
          title: "Highlights",
          content: [
            {
              ...
              enginetext: "Reliability and Safety",
              description:
                "Designed for long-range reliability, it established operational benchmarks for high-bypass engines.",
            },
            {
              image: productImages.Jt9d_H_2,
              enginetext: "Performance and Capability",
              description:
                "The JT9D allowed aircraft to fly farther with heavier payloads, revolutionizing the economics of long-haul travel.",
            },
            {
              image: productImages.Jt9d_H_3,
              enginetext: "Legacy and Impact",
              description:
                "It laid the foundation for all subsequent widebody engine development and was a direct predecessor to the PW4000 and other large turbofans.",
            },
          ],
        },
        {
          title: "Customers",
          content: [
            { name: "Pan Am", image: productImages.PanAm },
            { name: "United Airlines", image: productImages.UnitedAir },
            { name: "Lufthansa", image: productImages.lufthansa },
            { name: "Japan Airlines", image: productImages.japanAirline },
            { name: "Federal Express (FedEx)", image: productImages.fedEX },
          ],
        },
      ],
      gallery: [
        { img: productImages.Jt9d_1 },
        { img: productImages.Jt9d_2 },
        { img: productImages.Jt9d_3 },
        // {pdf:AUP_pdf_1},
      ],
    },
    wasp: {
      ...
      subTitle: "For PW India Experience Center",
      description:
        "The Pratt & Whitney R-1340 Wasp was the first engine produced by Pratt & Whitney in 1925. It is a 9-cylinder, air-cooled radial engine that became one of the most influential engines in aviation history. Renowned for its simplicity, power, and dependability, the Wasp powered a wide range of military and civilian aircraft, including trainers, bombers, and bush planes.",
      variants: [],
      logo: productImages.wasp_1925_2,
      defaultTabsData: [
        {
          title: "Platforms",
          content: [
            {
              image: productImages.wasp_P_1,
              enginetext: "North American T-6 Texan",
              description: "",
            },
            {
              image: productImages.wasp_P_2,
        ...
        },
        {
          title: "Specifications",
          content: [
            { image: productImages.thrust_new, description: "~450–600 hp power" },
            { image: productImages.PW210_S_2, description: "9-cylinder air-cooled radial" },
          ],
        },
        {
          ...
          content: [
            {
              ...
              enginetext: "Reliability and Safety",
              description:
                "The Wasp was highly reliable and remained in use for decades, powering training and utility aircraft with minimal maintenance.",
            },
            {
              image: productImages.wasp_H_2,
              enginetext: "Performance and Capability",
              description:
                "Its lightweight and powerful design allowed for excellent performance in both civilian and military platforms, especially in rugged or remote environments.",
            },
            {
              image: productImages.wasp_H_3,
              enginetext: "Legacy and Impact",
              description:
                "The Wasp engine earned a reputation as a cornerstone of early 20th-century aviation and set a foundation for Pratt & Whitney’s dominance in radial engine design.",
            },
          ],
        },
        {
          title: "Customers",
          content: [
            { name: "United States Navy", image: productImages.USN },
      ...
      gallery: [
        { img: productImages.wasp_1925_1 },
        { img: productImages.wasp_1925_2 },
        { img: productImages.wasp_1925_3 },
        { video: productImages.wasp_V1 },
        { video: productImages.wasp_V2 },
        // {pdf:AUP_pdf_2},
      ],
    },
  },
