...
export const productEngines = [
  null,
    ...
    engines: [
      ...
      { id: 'PW100', img: productImages.PW100150, title: 'PW100/150', description: "Powering regional aircraft around the world.", details: engineDetails.regional["PW100/150"] },
  ...
  },
  {
    ...
    engines: [
      ...
      { id: 'APS3200', img: productImages.APS3200_3, title: 'APS3200', description: "Airbus baseline APU of choice for the A320 family", details: engineDetails.APUs.APS3200 },
  ...
  },
   {
    ...
    engines: [
        { id: 'Hornet', img: productImages.hornet, title: 'Hornet', description: "9-cylinder, air-cooled radial engine powering many iconic aircraft", details: engineDetails.legacy_engines.Hornet },
          { id: 'JT3D', img: productImages.jt3d, title: 'JT3D', description: "One of the first successful low-bypass turbofan engines, powered the dawn of the Jet Age", details: engineDetails.legacy_engines.JT3D },
      { id: 'JT8D', img: productImages.Jt8d, title: 'JT8D', description: "Powered some of the most successful commercial jets in history, including 727 and 737", details: engineDetails.legacy_engines.JT8D },
      { id: 'JT9D', img: productImages.Jt9d, title: 'JT9D', description: "Opened a new era in commercial aviation with the high-bypass-ratio engine", details: engineDetails.legacy_engines.JT9D },
      { id: 'wasp', img: productImages.wasp, title: 'Wasp', description: "Pratt & Whitney’s first engine – and one of the most influential in history", details: engineDetails.legacy_engines.wasp },
